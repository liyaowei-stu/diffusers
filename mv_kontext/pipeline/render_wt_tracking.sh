...
for conf_threshold in 10.0; do
    ...
    output_dir="data/cache/conf_${conf_threshold}_8_recon_num_wt_tracking"
    
    python mv_kontext/pipeline/render_wt_tracking.py \
        --meta_path mv_kontext/data/navi/metainfo/navi_v1.5_metainfo_reorg.json \
        --data_dir mv_kontext/data/navi/navi_v1.5 \
